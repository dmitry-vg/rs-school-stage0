console.log('вёрстка +10,  Кнопка Play/Pause +10, трекі переключаются +10, меняется обложка +10, есть прогрес бар +5 (нет ползунка перемотки), отображается время проигрывания +10 — всего 55 баллов'); 
